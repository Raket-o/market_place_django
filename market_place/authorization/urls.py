...
urlpatterns = [
    ...
    path("telegram/<str:jwt_token>/", TelegramRegisterView.as_view(), name="telegram_register"),
    ...
    path("users/<int:pk>?tab=user&field=username/", UserNameUpdateView.as_view(), name="user_username_update"),
